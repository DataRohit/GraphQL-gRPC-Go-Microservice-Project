...
const (
	...
	ProductService_ListProductsWithIDs_FullMethodName = "/ProductService/ListProductsWithIDs"
...
func (c *productServiceClient) ListProductsWithIDs(ctx context.Context, in *ListProductsWithIDsRequest, opts ...grpc.CallOption) (*ListProductsWithIDsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProductsWithIDsResponse)
	err := c.cc.Invoke(ctx, ProductService_ListProductsWithIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductServiceServer) ListProductsWithIDs(context.Context, *ListProductsWithIDsRequest) (*ListProductsWithIDsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListProductsWithIDs not implemented")
}
...
func _ProductService_ListProductsWithIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListProductsWithIDsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).ListProductsWithIDs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_ListProductsWithIDs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ListProductsWithIDs(ctx, req.(*ListProductsWithIDsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_ListProductsWithIDs_Handler,
		},
		{
